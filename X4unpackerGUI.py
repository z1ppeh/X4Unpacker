...
class X4UnpackerGUI:
    ...
    def create_widgets(self):
        ...
        ttk.Label(thread_frame, text=f"Thread count (Max {max_threads} cores):").pack(side=tk.LEFT)
        ...
        lbl_recommend = ttk.Label(
            settings_group, 
            text="Recommended: HDD: 1-2 | SSD: 4-6 | NVMe: 8+", 
            font=("Segoe UI", 8, "italic"), 
            foreground="#555555"
        )
        lbl_recommend.pack(anchor=tk.W, pady=(2, 10))
    ...
    def update_dlc_selection(self, source_dir):
        ...
        for idx, (identifier, display_name) in enumerate(options):
            ...
            lbl_size = tk.Label(self.dlc_container, text="", font=("Segoe UI", 8), fg="#555555")
